...
const tools: Tool[] = [
  {
    ...
    description: "Advanced reasoning & code generation. My primary AI assistant for complex projects.",
    category: "AI Model",
  ...
  {
    name: "Open Design",
    description: "AI-powered design tool for creating stunning visuals and interfaces.",
    category: "Design",
  ...
  {
    name: "Gemini 3.1 Pro",
    description: "Google's multimodal powerhouse. Great for image understanding and large context.",
    category: "AI Model",
  ...
  {
    name: "Kimi K2.6 Pro",
    description: "Extended context specialist. Perfect for analyzing long documents and research.",
    category: "AI Model",
  ...
  {
    name: "SuperGrok",
    description: "Real-time knowledge & witty responses. xAI's answer to conversational AI.",
    category: "AI Model",
...
function getIcon(iconName: string) {
  ...
  switch (iconName) {
    ...
    case "code":
      return (
        <svg className={`${iconClass} text-violet-400`} fill="none" viewBox="0 0 24 24" stroke="currentColor">
  ...
  return (
    <div className="h-full bg-background/50 backdrop-blur-sm flex flex-col">
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="flex items-center gap-2 mb-1 flex-wrap">
                      ...
                      <span className="flex-shrink-0 px-2 py-0.5 text-[10px] rounded-full bg-cyan-400/20 text-cyan-400 border border-cyan-400/30">
                        {tool.category}
                      </span>
                    </div>
      ...
      <motion.div
        ...
        className="flex-shrink-0 py-3 text-center text-xs text-muted-foreground border-t border-border/30"
      >
