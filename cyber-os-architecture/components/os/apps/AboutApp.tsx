...
const techStack = [
  ...
  {
    name: "Kimi K2.6 Pro",
    description: "Long Context Research",
    icon: "K",
    color: "#FF6B6B",
  },
  {
...
const projects = [
  {
    name: "CyberOS",
    description:
      "A simulated operating system with draggable windows and multiple apps",
    tech: ["Next.js", "TypeScript", "Framer Motion"],
  },
  {
    name: "AI Research Hub",
    description:
      "Comparing and analyzing different AI models for various tasks",
    tech: ["Claude", "Gemini", "Kimi"],
  },
  {
    name: "Game Optimization Scripts",
    description:
      "Registry tweaks and system optimizations for better gaming performance",
...
export function AboutApp() {
  return (
    <div className="h-full bg-background/50 backdrop-blur-sm overflow-auto">
      {/* Header */}
      <div className="relative h-36 bg-linear-to-br from-cyan-500/20 via-blue-500/20 to-purple-500/20 overflow-hidden">
        ...
        >
          <motion.div
            ...
            className="w-20 h-20 rounded-lg bg-linear-to-br from-cyan-400 to-blue-500 flex items-center justify-center text-3xl font-bold text-black shadow-lg shadow-cyan-500/30"
          >
            MA
          </motion.div>
          <div>
            ...
            <p className="text-sm text-cyan-400">
              15 y.o. Vibe Coder from Kazakhstan
            </p>
          </div>
        </motion.div>
      </div>
      ...
      <div className="p-6 space-y-6">
        ...
        >
          ...
          <p className="text-sm text-muted-foreground leading-relaxed">
            I&apos;m a young developer passionate about AI, creative coding, and
            building cool stuff. I love exploring new technologies, especially
            AI models like Claude, Gemini, and Kimi. My approach is &quot;Vibe
            Coding&quot; - writing code that feels right and looks amazing.
          </p>
        </motion.section>
